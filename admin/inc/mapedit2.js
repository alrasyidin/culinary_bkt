...
function initialize(){
  ...
  var infowindow = new google.maps.InfoWindow;
   ...
   //menampilkan digitasi ik
  kuliner_reg = new google.maps.Data();
  kuliner_reg.loadGeoJson('act/kuliner_region.php?id_tempat_kuliner='+id_tempat_kuliner.value);
  kuliner_reg.setMap(map);
  kuliner_reg.setStyle({
    fillColor: 'red',
    strokeColor: 'red'
  });
  //zoom peta sesuai digitasi
  var bounds = new google.maps.LatLngBounds();
  kuliner_reg.addListener('addfeature', function(e) {
